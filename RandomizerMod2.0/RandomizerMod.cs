...
namespace RandomizerMod
{
    public class RandomizerMod : Mod<SaveSettings>
    {
        ...
        private void EditUI()
        {
            ...
            {
                {"All Bosses", allBossesText},
                {"All Skills", allSkillsText},
                {"All Charms", allCharmsText},
                {"Salubra Notches", charmNotchText},
                {"Lemm Sell All", lemmText},
                {"Preset", presetText},
                {"Shade Skips", shadeSkipsText},
                {"Acid Skips", acidSkipsText},
                {"Spike Tunnels", spikeTunnelsText},
                {"Misc Skips", miscSkipsText},
                {"Fireball Skips", fireballSkipsText},
                {"Mag Skips", magolorText}
            };
        ...
        private void StartNewGame(bool randomizer)
        {
            Settings = new SaveSettings
            {
                ...
                charmNotch = newGameSettings.charmNotch,
                lemm = newGameSettings.lemm,
                allBosses = newGameSettings.allBosses,
                allCharms = newGameSettings.allCharms,
                allSkills = newGameSettings.allSkills
            };
